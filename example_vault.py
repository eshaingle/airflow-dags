...
os.environ['AIRFLOW__SECRETS__BACKEND_KWARGS'] = '{"connections_path": "myapp", "mount_point": "secret", "auth_type": "token", "token": "s.QxCLhYDbDdf3eo66ORtKopgS", "url": "http://vault:8200"}'
