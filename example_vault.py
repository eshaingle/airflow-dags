...
os.environ['AIRFLOW__SECRETS__BACKEND_KWARGS'] = '{"connections_path": "message", "mount_point": "kv", "auth_type": "token", "token": "s.aSGhYbNQX2Hknn4Iij9ZA7mZ", "url": "http://vault.default.svc.cluster.local:8200"}'
